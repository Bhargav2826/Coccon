...
// node_modules/@livekit/components-react/dist/hooks-0IvkS6LV.mjs
...
async function Zt(e3, t) {
  ...
  } : s2.reference, E = await (o.getOffsetParent == null ? void 0 : o.getOffsetParent(a.floating)), O3 = await (o.isElement == null ? void 0 : o.isElement(E)) ? await (o.getScale == null ? void 0 : o.getScale(E)) || {
    x: 1,
    y: 1
  } : {
    x: 1,
  ...
  return {
    top: (h.top - b.top + m.top) / O3.y,
    bottom: (b.bottom - h.bottom + m.bottom) / O3.y,
    left: (h.left - b.left + m.left) / O3.x,
    right: (b.right - h.right + m.right) / O3.x
  };
}
var ur = function(e3) {
  return e3 === void 0 && (e3 = {}), {
    ...
    async fn(t) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const h = le(i2), x2 = ie(a), E = le(a) === a, O3 = await (c.isRTL == null ? void 0 : c.isRTL(u.floating)), b = v || (E || !p ? [Ne(a)] : tr(a)), S = m !== "none";
      !v && S && b.push(...or(a, p, m, O3));
      const C = [a, ...b], $2 = await Zt(t, g), M2 = [];
      let V2 = ((r = o.flip) == null ? void 0 : r.overflows) || [];
      if (l && M2.push($2[h]), f) {
        const Q2 = er(i2, s2, O3);
      ...
      if (V2 = [...V2, {
        ...
        var T2, _2;
        const Q2 = (((T2 = o.flip) == null ? void 0 : T2.index) || 0) + 1, Se2 = C[Q2];
        if (Se2 && (!(f === "alignment" ? x2 !== ie(Se2) : false) || // We leave the current main axis only if every placement on that axis
        ...
        let Te = (_2 = V2.filter((ae) => ae.overflows[0] <= 0).sort((ae, Y2) => ae.overflows[1] - Y2.overflows[1])[0]) == null ? void 0 : _2.placement;
        if (!Te)
          switch (d) {
            case "bestFit": {
              var ee2;
              const ae = (ee2 = V2.filter((Y2) => {
                if (S) {
                ...
                return true;
              }).map((Y2) => [Y2.placement, Y2.overflows.filter((re2) => re2 > 0).reduce((re2, Yn2) => re2 + Yn2, 0)]).sort((Y2, re2) => Y2[1] - re2[1])[0]) == null ? void 0 : ee2[0];
              ae && (Te = ae);
              break;
            }
...
function fe(e3, t, n, r) {
  ...
  if (o) {
    ...
    let m = v, p = at(m);
    for (; p && r && d !== m; ) {
      const g = he(p), h = p.getBoundingClientRect(), x2 = G(p), E = h.left + (p.clientLeft + parseFloat(x2.paddingLeft)) * g.x, O3 = h.top + (p.clientTop + parseFloat(x2.paddingTop)) * g.y;
      c *= g.x, u *= g.y, l *= g.x, f *= g.y, c += E, u += O3, m = j(p), p = at(m);
    }
  }
  return Fe({
    width: l,
...
function Fr(e3, t) {
  ...
  function s2(a, c) {
    ...
    function b(S) {
      ...
      C === 1 && !cn(u, e3.getBoundingClientRect()) && s2(), O3 = false;
    }
    try {
      ...
      function d(p, g) {
        ...
        function C() {
          ...
          if (!(typeof window === n || !b)) {
            ...
            if (typeof T2 === n)
              try {
                var _2 = window.document.cookie, ee2 = encodeURIComponent(b), Q2 = _2.indexOf(ee2 + "=");
                Q2 !== -1 && (T2 = /^([^;]+)/.exec(
                  _2.slice(Q2 + ee2.length + 1)
                )[1]);
              } catch {
              }
        ...
        h.name = p, h.levels = {
          ...
          return O3 = M2(T2), _2 !== false && S(O3), l.call(h);
...
function Ki(e3) {
  ...
  return function(u) {
    ...
    return W(function(E, O3) {
      d++, !p && !m && g();
      var b = v = v ?? n();
      O3.add(function() {
        d--, d === 0 && !p && !m && (f = nt(x2, c));
      }), b.subscribe(O3), !l && d > 0 && (l = new Pe({
        next: function(S) {
          return b.next(S);
        },
        error: function(S) {
...
function Ws(e3, t) {
  ...
  const g = m.pipe(
    ...
    try {
      ...
      try {
        ...
        L.info("could not send message in legacy chat format", ee2);
      }
      return T2;
    } finally {
      h.next(false);
  ...
  return e3.once(RoomEvent.Disconnected, O3), {
    messageObservable: g,
...
function $(n) {
  ...
  const [s2, O3] = i.useState(), C = i.useRef(a);
  i.useEffect(() => {
    O3(r ?? new Room(t));
  ...
  return i.useEffect(() => {
    ...
    return s2.on(RoomEvent.SignalConnected, m).on(RoomEvent.MediaDevicesError, P2).on(RoomEvent.EncryptionError, S).on(RoomEvent.Disconnected, k2).on(RoomEvent.Connected, D2), () => {
      s2.off(RoomEvent.SignalConnected, m).off(RoomEvent.MediaDevicesError, P2).off(RoomEvent.EncryptionError, S).off(RoomEvent.Disconnected, k2).off(RoomEvent.Connected, D2);
    };
  }, [
    s2,
    p,
...
function Wt2(e3, n) {
  ...
  return s.useLayoutEffect(() => {
    ...
    return t == null || t.subscribe(i2, a), () => {
      o = true, t == null || t.unsubscribe(i2, a);
    };
...
function zt2() {
  ...
  if (typeof window > "u")
    return;
  const r = new ResizeObserver((o, i2) => {
...
var Jt2 = (e3) => {
  ...
  s.useLayoutEffect(() => {
    if (e3.current) {
      const { width: o, height: i2 } = e3.current.getBoundingClientRect();
      t({ width: o, height: i2 });
    }
  }, [e3.current]);
...
function O(e3, n, t = true) {
  const [r, o] = s.useState(n);
  return s.useEffect(() => {
    if (t && o(n), typeof window > "u" || !e3) return;
    const i2 = e3.subscribe(o);
    return () => i2.unsubscribe();
  }, [e3, t]), r;
}
function Dn2(e3) {
  const n = (i2) => typeof window < "u" ? window.matchMedia(i2).matches : false, [t, r] = s.useState(n(e3));
  function o() {
    r(n(e3));
  }
  return s.useEffect(() => {
    const i2 = window.matchMedia(e3);
    return o(), i2.addListener ? i2.addListener(o) : i2.addEventListener("change", o), () => {
      i2.removeListener ? i2.removeListener(o) : i2.removeEventListener("change", o);
    };
  }, [e3]), t;
}
function In2(e3) {
...
function Fn2(e3, n) {
  const t = typeof e3 == "function" ? e3 : n, r = typeof e3 == "string" ? e3 : void 0, o = ua(), { send: i2, messageObservable: a, isSendingObservable: c } = s.useMemo(
    () => Do(o, r, t),
    [o, r, t]
  ), u = O(a, void 0), p = O(c, false);
  return {
    message: u,
    send: i2,
    isSending: p
...
function xn2(e3) {
  const n = ua(), t = re(n);
  return { buttonProps: s.useMemo(() => {
    const { className: o, disconnect: i2 } = Ds(n);
    return M(e3, {
      className: o,
      onClick: () => i2(e3.stopTracks ?? true),
...
function Un2({ trackRef: e3, props: n }) {
  const t = sa(e3), r = Ko(), { className: o } = s.useMemo(() => Hs(), []), i2 = s.useMemo(() => ns(t, r == null ? void 0 : r.pin.state), [t, r == null ? void 0 : r.pin.state]);
  return { mergedProps: s.useMemo(
    () => M(n, {
      className: o,
      onClick: (c) => {
        var u, p, h, l, d;
        (u = n.onClick) == null || u.call(n, c), i2 ? (h = r == null ? void 0 : (p = r.pin).dispatch) == null || h.call(p, {
          msg: "clear_pin"
    ...
    [n, o, t, i2, r == null ? void 0 : r.pin]
  ), inFocus: i2 };
}
function Hn2(e3, n, t = {}) {
  const r = t.gridLayouts ?? fs, { width: o, height: i2 } = Jt2(e3), a = lo(r, n, o, i2);
  return s.useEffect(() => {
...
function Ee2(e3, n = {}) {
  var c, u;
  const t = typeof e3 == "string" ? n.participant : e3.participant, r = ca(t), o = typeof e3 == "string" ? { participant: r, source: e3 } : e3, [i2, a] = s.useState(
...
function xe2(e3 = {}) {
  const n = la(e3.room), [t, r] = s.useState(n.localParticipant), [o, i2] = s.useState(
    t.isMicrophoneEnabled
  ), [a, c] = s.useState(t.isCameraEnabled), [u, p] = s.useState(
    t.isScreenShareEnabled
  ), [h, l] = s.useState(
    t.lastMicrophoneError
  ), [d, v] = s.useState(t.lastCameraError), [M2, w] = s.useState(
    void 0
  ), [A3, P2] = s.useState(void 0), D2 = (R) => {
    c(R.isCameraEnabled), i2(R.isMicrophoneEnabled), p(R.isScreenShareEnabled), P2(R.cameraTrack), w(R.microphoneTrack), l(R.participant.lastMicrophoneError), v(R.participant.lastCameraError), r(R.participant);
  };
  return s.useEffect(() => {
    const R = Dn(n.localParticipant).subscribe(D2);
...
function Bn2() {
  ...
  return O(n, e3.localParticipant.permissions);
}
function Vn2({
  kind: e3,
  room: n,
  ...
  const i2 = Qo(), a = s.useMemo(() => n ?? i2 ?? new Room(), [n, i2]), c = s.useMemo(
    () => Ts(e3, o, r),
    [e3, r, o]
  ...
  return s.useEffect(() => {
    const M2 = d.subscribe((w) => {
      w && (L.info("setCurrentDeviceId", w), h(w));
    });
    return () => {
      M2 == null || M2.unsubscribe();
    };
...
function Kt2(e3, n, t = {}) {
  const r = s.useRef([]), o = s.useRef(-1), i2 = n !== o.current, a = typeof t.customSortFunction == "function" ? t.customSortFunction(e3) : ms(e3);
  let c = [...a];
  if (i2 === false)
    try {
      c = bs(r.current, a, n);
  ...
  return i2 ? r.current = a : r.current = c, o.current = n, c;
}
function jn2(e3, n) {
  const [t, r] = s.useState(1), o = Math.max(Math.ceil(n.length / e3), 1);
  t > o && r(o);
  const i2 = t * e3, a = i2 - e3, c = (l) => {
    r((d) => l === "next" ? d === o ? d : d + 1 : d === 1 ? d : d - 1);
  }, u = (l) => {
    l > o ? r(o) : l < 1 ? r(1) : r(l);
  }, h = Kt2(n, e3).slice(a, i2);
  return {
    totalPageCount: o,
    nextPage: () => c("next"),
    prevPage: () => c("previous"),
...
function Yt2(e3 = {}) {
  ...
  const t = s.useMemo(() => _o(n), [n]), { identity: r, name: o, metadata: i2 } = O(t, {
    name: n == null ? void 0 : n.name,
    identity: n == null ? void 0 : n.identity,
    metadata: n == null ? void 0 : n.metadata
  });
  return { identity: r, name: o, metadata: i2 };
}
function Wn2(e3 = {}) {
...
function zn2({
  ...
  const o = sa(e3), i2 = s.useMemo(() => {
    const { className: d } = Us();
    return M(r, {
      className: d,
      onClick: (v) => {
        var M2;
        if ((M2 = r.onClick) == null || M2.call(r, v), typeof n == "function") {
    ...
    o.source,
    o.participant
  ]), a = o.participant.getTrackPublication(Track.Source.Microphone), c = s.useMemo(() => ({
    participant: o.participant,
    source: Track.Source.Microphone,
    publication: a
  }), [a, o.participant]), u = Ee2(o), p = Ee2(c), h = Qt2(o.participant), l = $t2(o);
  return {
    elementProps: {
...
function Xt2(e3 = {}) {
  const n = ve2(e3), { localParticipant: t } = xe2(e3);
  return s.useMemo(
    () => [t, ...n],
    [t, n]
  );
...
function Jn2(e3, n = {}) {
  const t = ua(), [r] = s.useState(n.updateOnlyOn), o = s.useMemo(() => typeof e3 == "string" ? As(t, e3, {
    ...
    additionalEvents: r
  }), [t, JSON.stringify(e3), r]), [i2, a] = s.useState({
    p: void 0
  });
  return s.useEffect(() => {
...
function $n2(e3 = {}) {
  const n = la(e3.room), t = s.useMemo(() => xs(n), [n]), { name: r, metadata: o } = O(t, {
    name: n.name,
    metadata: n.metadata
  });
...
function Kn({ room: e3, props: n }) {
  const t = la(e3), { className: r, roomAudioPlaybackAllowedObservable: o, handleStartAudioPlayback: i2 } = s.useMemo(
    () => js(),
    []
  ), a = s.useMemo(
    () => o(t),
...
function Yn({ room: e3, props: n }) {
  const t = la(e3), { className: r, roomVideoPlaybackAllowedObservable: o, handleStartVideoPlayback: i2 } = s.useMemo(
    () => Bs(),
    []
  ), a = s.useMemo(
    () => o(t),
...
function Xn2(e3, n = {}) {
  const t = s.useRef(null), r = s.useRef(null), o = n.minSwipeDistance ?? 50, i2 = (u) => {
  ...
  s.useEffect(() => {
    const u = e3.current;
    return u && (u.addEventListener("touchstart", i2, { passive: true }), u.addEventListener("touchmove", a, { passive: true }), u.addEventListener("touchend", c, { passive: true })), () => {
      u && (u.removeEventListener("touchstart", i2), u.removeEventListener("touchmove", a), u.removeEventListener("touchend", c));
    };
  }, [e3, c]);
}
function Zn2({ props: e3 }) {
...
function er2(e3, n, t = {}) {
  ...
  return s.useEffect(() => {
    ...
    (async () => {
      ...
      const c = new URLSearchParams({ ...t.userInfo, roomName: n }), u = await fetch(`${e3}?${c.toString()}`);
      if (!u.ok) {
        L.error(
...
function tr2(e3) {
  ...
  return { isMuted: O(
    r,
    !!((i2 = n.publication) != null && i2.isMuted || (a = n.participant.getTrackPublication(n.source)) != null && a.isMuted)
  ), className: t };
}
function nr2({
  source: e3,
  ...
  var m;
  const u = Qo(), p = s.useMemo(() => a ?? u, [a, u]), h = (m = p == null ? void 0 : p.localParticipant) == null ? void 0 : m.getTrackPublication(e3), l = s.useRef(false), { toggle: d, className: v, pendingObserver: M2, enabledObserver: w } = s.useMemo(
    () => p ? Is(e3, p, r, o, i2) : Ms(),
    [p, e3, JSON.stringify(r), o]
  ), A3 = O(M2, false), P2 = O(w, t ?? !!(h != null && h.isEnabled));
  s.useEffect(() => {
    n == null || n(P2, l.current), l.current = false;
  }, [P2, n]), s.useEffect(() => {
    t !== void 0 && (L.debug("forcing initial toggle state", e3, t), d(t));
  }, []);
  const D2 = s.useMemo(() => M(c, { className: v }), [c, v]), R = s.useCallback(
    (f) => {
      var b;
      l.current = true, d().catch(() => l.current = false), (b = c.onClick) == null || b.call(c, f);
    },
    [c, d]
  );
  return {
...
function rr2(e3 = [
  ...
  const t = la(n.room), [r, o] = s.useState([]), [i2, a] = s.useState([]), c = s.useMemo(() => e3.map((p) => ho(p) ? p.source : p), [JSON.stringify(e3)]);
  return s.useEffect(() => {
    const p = qs(t, c, {
      additionalRoomEvents: n.updateOnlyOn,
      onlySubscribed: n.onlySubscribed
    }).subscribe(({ trackReferences: h, participants: l }) => {
      L.debug("setting track bundles", h, l), o(h), a(l);
    });
    return () => p.unsubscribe();
  }, [
    t,
    ...
    if (vs(e3)) {
      const p = tn2(e3, i2), h = Array.from(r);
      return i2.forEach((l) => {
        p.has(l.identity) && (p.get(l.identity) ?? []).forEach((v) => {
          if (r.find(
            ({ participant: w, publication: A3 }) => l.identity === w.identity && A3.source === v
          ))
            return;
          L.debug(
...
function sr2(e3, n) {
  const t = ca(n);
  return nn2({ name: e3, participant: t });
}
function rn2(e3) {
  const n = la(e3 == null ? void 0 : e3.room), t = re(n), r = s.useMemo(
    () => t === ConnectionState.Disconnected,
    [t]
  ), o = s.useMemo(
    () => Ws(n, e3),
    [n, e3, r]
  ), i2 = O(o.isSendingObservable, false), a = O(o.messageObservable, []);
  return { send: o.send, chatMessages: a, isSending: i2 };
}
function or2(e3 = {}) {
  const [n, t] = s.useState(
...
function ir2(e3, n = { fftSize: 32, smoothingTimeConstant: 0 }) {
  const t = B(e3) ? e3.publication.track : e3, [r, o] = s.useState(0);
  return s.useEffect(() => {
    if (!t || !t.mediaStream)
      return;
    const { cleanup: i2, analyser: a } = createAudioAnalyser(t, n), c = a.frequencyBinCount, u = new Uint8Array(c), h = setInterval(() => {
...
var sn2 = (e3) => {
  const n = (t) => {
    let i2 = 1 - Math.max(-100, Math.min(-10, t)) * -1 / 100;
    return i2 = Math.sqrt(i2), i2;
  };
...
function cr2(e3, n = {}) {
  var a;
  const t = e3 instanceof Track ? e3 : (a = e3 == null ? void 0 : e3.publication) == null ? void 0 : a.track, r = { ...on2, ...n }, [o, i2] = s.useState(
  ...
  return s.useEffect(() => {
    ...
    const { analyser: c, cleanup: u } = createAudioAnalyser(t, r.analyserOptions), p = c.frequencyBinCount, h = new Float32Array(p), d = setInterval(() => {
      ...
      const M2 = sn2(v), w = M2.length, A3 = [];
      for (let P2 = 0; P2 < r.bands; P2++) {
        const D2 = Math.floor(P2 * w / r.bands), R = Math.floor((P2 + 1) * w / r.bands), m = M2.slice(D2, R), f = m.length;
        if (f === 0)
          A3.push(0);
        else {
...
function ur2(e3, n = {}) {
  var h;
  const t = e3 instanceof Track ? e3 : (h = e3 == null ? void 0 : e3.publication) == null ? void 0 : h.track, r = { ...an2, ...n }, o = s.useRef(new Float32Array()), i2 = s.useRef(performance.now()), a = s.useRef(0), [c, u] = s.useState([]), p = s.useCallback((l) => {
    u(
      Array.from(
        un2(l, r.barCount).map((d) => Math.sqrt(d) * r.volMultiplier)
  ...
  return s.useEffect(() => {
    if (!t || !(t != null && t.mediaStream))
      return;
    const { analyser: l, cleanup: d } = createAudioAnalyser(t, {
      fftSize: ke2(r.barCount)
    }), v = ke2(r.barCount), M2 = new Float32Array(v), w = () => {
      if (A3 = requestAnimationFrame(w), l.getFloatTimeDomainData(M2), o.current.map((P2, D2) => P2 + M2[D2]), a.current += 1, performance.now() - i2.current >= r.updateInterval) {
        const P2 = M2.map((D2) => D2 / a.current);
        p(P2), i2.current = performance.now(), a.current = 0;
      }
    };
    let A3 = requestAnimationFrame(w);
    return () => {
      d(), cancelAnimationFrame(A3);
    };
...
function ie2(e3, n = {}) {
  ...
  const o = Go(), i2 = Xt2({ room: r, updateOnlyOn: [] }), a = s.useMemo(() => t ? i2.find((p) => p.identity === t) : o, [t, i2, o]), c = s.useMemo(() => {
    if (a)
...
function dn2(e3) {
  ...
  const n = s.useMemo(
    () => {
      var i2;
      return (i2 = e3 == null ? void 0 : e3.publication) != null && i2.track ? Qs(e3 == null ? void 0 : e3.publication.track) : void 0;
    },
...
function fn2(e3, n) {
  const t = { ...ln2, ...n }, [r, o] = s.useState([]), i2 = dn2(e3), a = (c) => {
    var u;
  ...
  return s.useEffect(() => {
    if (!(e3 != null && e3.publication))
      return;
    const c = Gs(e3.publication).subscribe((u) => {
      a(...u);
    });
    return () => {
      c.unsubscribe();
...
var we2 = po.AgentState;
function lr2() {
  const e3 = ve2(), n = e3.find(
    (l) => l.kind === ParticipantInfo_Kind.AGENT && !(po.PublishOnBehalf in l.attributes)
  ), t = e3.find(
    (l) => l.kind === ParticipantInfo_Kind.AGENT && l.attributes[po.PublishOnBehalf] === (n == null ? void 0 : n.identity)
  ), r = ie2(
  ...
  ), i2 = r.find((l) => l.source === Track.Source.Microphone) ?? o.find((l) => l.source === Track.Source.Microphone), a = r.find((l) => l.source === Track.Source.Camera) ?? o.find((l) => l.source === Track.Source.Camera), { segments: c } = fn2(i2), u = re(), { attributes: p } = mn2({ participant: n }), h = s.useMemo(() => u === ConnectionState.Disconnected ? "disconnected" : u === ConnectionState.Connecting || !n || !(p != null && p[we2]) ? "connecting" : p[we2], [p, n, u]);
  return {
    agent: n,
    state: h,
    audioTrack: i2,
...
function fr2(e3) {
  const n = la(e3), t = re(n), r = s.useMemo(() => Cs(n), [n, t]);
  return O(r, n.isRecording);
}
function pn2(e3, n) {
  const t = la(n == null ? void 0 : n.room), o = re(t) === ConnectionState.Disconnected, i2 = s.useMemo(() => ea(t, e3), [t, e3]);
  return { textStreams: O(o ? void 0 : i2, []) };
}
function hn2(e3) {
  const { participantIdentities: n, trackSids: t } = e3 ?? {}, { textStreams: r } = pn2(Mo.TRANSCRIPTION, { room: e3 == null ? void 0 : e3.room });
  return s.useMemo(
    () => r.filter(
      (i2) => n ? n.includes(i2.participantInfo.identity) : true
    ).filter(
      (i2) => {
        var a;
        return t ? t.includes(
          ((a = i2.streamInfo.attributes) == null ? void 0 : a[po.TranscribedTrackId]) ?? ""
        ) : true;
      }
    ),
    [r, n, t]
...
function mr2(e3) {
  ...
  }), []), o = (0, import_react.useRef)([]), i2 = (0, import_react.useCallback)((h) => {
    let l = 0;
    o.current = o.current.filter((d) => {
      const v = h.getTime() - d.getTime() < Re2;
      return v && (l += 1), v;
    }), l > Ae2 && L.warn(
      `useSequentialRoomConnectDisconnect: room changed reference rapidly (over ${Ae2}x in ${Re2}ms). This is not recommended.`
    );
  }, []);
  (0, import_react.useEffect)(() => {
    n.current = [];
    const h = /* @__PURE__ */ new Date();
    o.current.push(h), i2(h);
  }, [e3, i2]);
  const a = (0, import_react.useRef)([]), c = (0, import_react.useCallback)((h) => {
    let l = 0;
    a.current = a.current.filter((d) => {
      const v = h.getTime() - d.getTime() < Le2;
      return v && (l += 1), v;
    }), l > Pe2 && L.warn(
      `useSequentialRoomConnectDisconnect: room connect / disconnect occurring in rapid sequence (over ${Pe2}x in ${Le2}ms). This is not recommended and may be the sign of a bug like a useEffect dependency changing every render.`
    );
    ...
    async (...h) => new Promise((l, d) => {
      ...
      c(v), n.current.push({ type: "connect", room: e3, args: h, resolve: l, reject: d }), a.current.push(v), r();
    }),
    [e3, c, r]
    ...
    async (...h) => new Promise((l, d) => {
      ...
      const v = /* @__PURE__ */ new Date();
      c(v), n.current.push({ type: "disconnect", room: e3, args: h, resolve: l, reject: d }), a.current.push(v), r();
    }),
    [e3, c, r]
  );
  return {
...
function bn2() {
  ...
  oe2.exports = i2, oe2.exports.once = P2, i2.EventEmitter = i2, i2.prototype._events = void 0, i2.prototype._eventsCount = 0, i2.prototype._maxListeners = void 0;
  var a = 10;
  function c(m) {
    if (typeof m != "function")
      throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof m);
  }
  Object.defineProperty(i2, "defaultMaxListeners", {
    enumerable: true,
    get: function() {
      return a;
    },
  ...
  }, i2.prototype.setMaxListeners = function(f) {
  ...
  function u(m) {
    return m._maxListeners === void 0 ? i2.defaultMaxListeners : m._maxListeners;
  }
  i2.prototype.getMaxListeners = function() {
    return u(this);
  }, i2.prototype.emit = function(f) {
    ...
    if (y) {
      ...
      if (b.length > 0 && (C = b[0]), C instanceof Error)
        throw C;
      var k2 = new Error("Unhandled error." + (C ? " (" + C.message + ")" : ""));
      throw k2.context = C, k2;
    }
    var F2 = T2[f];
    if (F2 === void 0)
      return false;
    if (typeof F2 == "function")
      ...
      for (var B3 = F2.length, H3 = M2(F2, B3), g = 0; g < B3; ++g)
        n(H3[g], this, b);
    return true;
  };
  function p(m, f, b, g) {
    var y, T2, C;
    if (c(b), T2 = m._events, T2 === void 0 ? (T2 = m._events = /* @__PURE__ */ Object.create(null), m._eventsCount = 0) : (T2.newListener !== void 0 && (m.emit(
      "newListener",
      f,
      b.listener ? b.listener : b
    ), T2 = m._events), C = T2[f]), C === void 0)
      C = T2[f] = b, ++m._eventsCount;
    else if (typeof C == "function" ? C = T2[f] = g ? [b, C] : [C, b] : g ? C.unshift(b) : C.push(b), y = u(m), y > 0 && C.length > y && !C.warned) {
      C.warned = true;
      var k2 = new Error("Possible EventEmitter memory leak detected. " + C.length + " " + String(f) + " listeners added. Use emitter.setMaxListeners() to increase limit");
      k2.name = "MaxListenersExceededWarning", k2.emitter = m, k2.type = f, k2.count = C.length, r(k2);
    }
    return m;
  }
  i2.prototype.addListener = function(f, b) {
    return p(this, f, b, false);
  }, i2.prototype.on = i2.prototype.addListener, i2.prototype.prependListener = function(f, b) {
  ...
  i2.prototype.once = function(f, b) {
    return c(b), this.on(f, l(this, f, b)), this;
  }, i2.prototype.prependOnceListener = function(f, b) {
    return c(b), this.prependListener(f, l(this, f, b)), this;
  }, i2.prototype.removeListener = function(f, b) {
    var g, y, T2, C, k2;
    ...
    if (g === b || g.listener === b)
      ...
      for (T2 = -1, C = g.length - 1; C >= 0; C--)
        if (g[C] === b || g[C].listener === b) {
          k2 = g[C].listener, T2 = C;
          break;
        }
      if (T2 < 0)
        return this;
      T2 === 0 ? g.shift() : w(g, T2), g.length === 1 && (y[f] = g[0]), y.removeListener !== void 0 && this.emit("removeListener", f, k2 || b);
    }
    return this;
  }, i2.prototype.off = i2.prototype.removeListener, i2.prototype.removeAllListeners = function(f) {
    var b, g, y;
    ...
    if (arguments.length === 0) {
      var T2 = Object.keys(g), C;
      for (y = 0; y < T2.length; ++y)
        C = T2[y], C !== "removeListener" && this.removeAllListeners(C);
  ...
  function d(m, f, b) {
    ...
    if (g === void 0)
      return [];
    var y = g[f];
    return y === void 0 ? [] : typeof y == "function" ? b ? [y.listener || y] : [y] : b ? A3(y) : M2(y, y.length);
  }
  i2.prototype.listeners = function(f) {
    return d(this, f, true);
  }, i2.prototype.rawListeners = function(f) {
    return d(this, f, false);
  }, i2.listenerCount = function(m, f) {
    return typeof m.listenerCount == "function" ? m.listenerCount(f) : v.call(m, f);
  }, i2.prototype.listenerCount = v;
  function v(m) {
    var f = this._events;
    if (f !== void 0) {
      var b = f[m];
...
var ge2 = bn2();
var vn2 = 2e4;
var gn2 = ((e3) => (e3.CameraChanged = "cameraChanged", e3.MicrophoneChanged = "microphoneChanged", e3.StateChanged = "stateChanged", e3))(gn2 || {});
var x = (e3) => ({
...
var Sn2 = () => {
  const [e3, n] = s.useState(
    ...
    null
  ), o = s.useRef("connecting"), i2 = s.useRef(false), a = (c) => setTimeout(() => {
    if (!i2.current) {
  ...
  return {
    ...
    startAgentTimeout: s.useCallback(
      (c) => {
        t && clearTimeout(t), n(null), r(a(c)), o.current = "connecting", i2.current = false;
      },
      [t]
    ),
    clearAgentTimeout: s.useCallback(() => {
      t && clearTimeout(t), n(null), r(null), o.current = "connecting", i2.current = false;
    }, [t]),
...
function yn2(e3, n) {
    ...
    async (a) => {
      ...
      if (!c)
        return new Promise((u, p) => {
          const h = (v) => {
            const { isConnected: M2 } = x(v);
            M2 && (d(), u());
          }, l = () => {
            d(), p(new Error("useAgent(/* ... */).waitUntilConnected - signal aborted"));
          }, d = () => {
            e3.off("stateChanged", h), a == null || a.removeEventListener("abort", l);
          };
          e3.on("stateChanged", h), a == null || a.addEventListener("abort", l);
        });
    },
    [e3]
  ), o = s.useCallback(
  ...
  return { waitUntilConnected: r, waitUntilCouldBeListening: o, waitUntilFinished: i2 };
}
function Ue2(e3) {
  const n = Jo();
  if (e3 = e3 ?? n, !e3)
  ...
  const {
    ...
    internal: {
      ...
      startAgentTimeout: i2,
      clearAgentTimeout: a,
      clearAgentTimeoutFailureReason: c,
      updateAgentTimeoutState: u,
      updateAgentTimeoutParticipantExists: p
    }
  } = e3, h = s.useMemo(() => new ge2.EventEmitter(), []), l = ve2({ room: t }), d = s.useMemo(() => l.find(
    (S) => S.kind === ParticipantInfo_Kind.AGENT && !(po.PublishOnBehalf in S.attributes)
  ) ?? null, [l]), v = s.useMemo(() => d ? l.find(
    (S) => S.kind === ParticipantInfo_Kind.AGENT && S.attributes[po.PublishOnBehalf] === d.identity
  ) ?? null : null, [d, l]), [M2, w] = s.useState((d == null ? void 0 : d.attributes) ?? {});
  s.useEffect(() => {
    if (!d)
      return;
    const S = (_2) => {
  ...
  const A3 = ie2([Track.Source.Camera, Track.Source.Microphone], {
    room: t,
    participantIdentity: d == null ? void 0 : d.identity
  }), P2 = ie2([Track.Source.Camera, Track.Source.Microphone], {
    room: t,
    participantIdentity: v == null ? void 0 : v.identity
  }), D2 = s.useMemo(
    () => A3.find((S) => S.source === Track.Source.Camera) ?? P2.find((S) => S.source === Track.Source.Camera),
    [A3, P2]
  );
  s.useEffect(() => {
    h.emit("cameraChanged", D2);
  }, [h, D2]);
  const R = s.useMemo(
    () => A3.find((S) => S.source === Track.Source.Microphone) ?? P2.find((S) => S.source === Track.Source.Microphone),
    [A3, P2]
  );
  s.useEffect(() => {
  ...
  s.useEffect(() => {
    if (!d)
      return;
    const S = (_2) => {
      _2.identity === (d == null ? void 0 : d.identity) && g("Agent left the room unexpectedly.");
    };
  ...
  const C = s.useMemo(() => {
    ...
    if (C.length > 0)
      return "failed";
    let S = "disconnected";
    return m !== ConnectionState.Disconnected && (S = "connecting"), y && (S = "pre-connect-buffering"), d && M2[po.AgentState] && (S = M2[po.AgentState]), S;
  }, [
    C,
    m,
    y,
  ...
  const {
    ...
    name: H3,
    metadata: K3
  } = Yt2({ participant: d ?? void 0 }), te3 = s.useMemo(() => {
    const S = {
      attributes: M2,
      internal: {
        agentParticipant: d,
    ...
    D2,
    R
  ]), { waitUntilConnected: X2, waitUntilCouldBeListening: L3, waitUntilFinished: N2 } = yn2(h, k2), q3 = s.useCallback(
    (S) => new Promise((_2, Z2) => {
      const W3 = (J3) => {
        J3 && (G3(), _2(J3));
      }, z3 = () => {
        G3(), Z2(new Error("useAgent(/* ... */).waitUntilCamera - signal aborted"));
      }, G3 = () => {
        h.off("cameraChanged", W3), S == null || S.removeEventListener("abort", z3);
      };
      h.on("cameraChanged", W3), S == null || S.addEventListener("abort", z3);
    }),
    [h]
  ), se2 = s.useCallback(
    (S) => new Promise((_2, Z2) => {
      const W3 = (J3) => {
        ...
        G3(), Z2(new Error("useAgent(/* ... */).waitUntilMicrophone - signal aborted"));
      }, G3 = () => {
        h.off("microphoneChanged", W3), S == null || S.removeEventListener("abort", z3);
      };
      h.on("microphoneChanged", W3), S == null || S.addEventListener("abort", z3);
    }),
    [h]
  );
  return s.useMemo(() => ({
    ...te3,
    waitUntilConnected: X2,
    waitUntilCouldBeListening: L3,
    waitUntilFinished: N2,
    waitUntilCamera: q3,
    waitUntilMicrophone: se2
  }), [
    te3,
    X2,
    L3,
...
var Cn2 = ((e3) => (e3.ConnectionStateChanged = "connectionStateChanged", e3.MediaDevicesError = "mediaDevicesError", e3.EncryptionError = "encryptionError", e3))(Cn2 || {});
function Mn2(e3, n) {
      ...
      if (t.current !== o)
        return new Promise((a, c) => {
          const u = (l) => {
            ...
            e3.off("connectionStateChanged", u), i2 == null || i2.removeEventListener("abort", p);
          };
          e3.on("connectionStateChanged", u), i2 == null || i2.addEventListener("abort", p);
        });
    },
    [e3]
  );
...
function En2(e3, n) {
  ...
  return s.useEffect(() => {
    ...
    r.current !== null && Mn2(r.current, n) || (r.current = n);
...
function pr2(e3, n = {}) {
  const { room: t, agentConnectTimeoutMilliseconds: r, ...o } = n, i2 = Qo(), a = s.useMemo(
    () => i2 ?? t ?? new Room(),
    [i2, t]
  ), c = s.useMemo(
    () => new ge2.EventEmitter(),
    []
  ), u = s.useCallback(
    (L3) => ({
  ...
  s.useEffect(() => {
    ...
    const L3 = async (N2) => {
      c.emit("encryptionError", N2);
    };
    return a.on(RoomEvent.EncryptionError, L3), () => {
      a.off(RoomEvent.EncryptionError, L3);
    };
  }, [a, c]);
  const { localParticipant: l } = xe2({ room: a }), d = l.getTrackPublication(Track.Source.Camera), v = s.useMemo(() => {
    if (d)
      return {
  ...
  }, [l, d]), M2 = l.getTrackPublication(Track.Source.Microphone), w = s.useMemo(() => {
    if (M2)
      return {
        source: Track.Source.Microphone,
        participant: l,
  ...
  }, [l, M2]), A3 = l.getTrackPublication(Track.Source.ScreenShare), P2 = s.useMemo(() => {
    if (A3)
      return {
  ...
  s.useEffect(() => {
    c.emit("connectionStateChanged", T2.connectionState);
  }, [c, T2.connectionState]);
  const C = Tn2(
    c,
    T2.connectionState
  ), k2 = s.useCallback(
    ...
    async (L3) => C(ConnectionState.Disconnected, L3),
    [C]
  ), B3 = Ue2(
    s.useMemo(
      () => ({
        connectionState: T2.connectionState,
        room: a,
        internal: y
      }),
      [T2, a, y]
    )
  ), H3 = En2(e3, o), K3 = s.useCallback(
    async (L3 = {}) => {
      var Z2, W3, z3, G3, J3, Se2;
      const {
        signal: N2,
        tracks: q3 = { microphone: { enabled: true, publishOptions: { preConnectBuffer: true } } },
        roomConnectOptions: se2
      } = L3;
      await F2(N2);
      const S = () => {
        a.disconnect();
      };
      N2 == null || N2.addEventListener("abort", S);
      let _2 = false;
      await Promise.all([
        H3().then(({ serverUrl: He2, participantToken: ye3 }) => {
          var Ce3, Me3;
          return _2 = (((Me3 = (Ce3 = decodeTokenPayload(ye3).roomConfig) == null ? void 0 : Ce3.agents) == null ? void 0 : Me3.length) ?? 0) > 0, a.connect(He2, ye3, se2);
        }),
        // Start microphone (with preconnect buffer) by default
        (Z2 = q3.microphone) != null && Z2.enabled ? a.localParticipant.setMicrophoneEnabled(
          true,
          void 0,
          ((W3 = q3.microphone) == null ? void 0 : W3.publishOptions) ?? {}
        ) : Promise.resolve(),
        (z3 = q3.camera) != null && z3.enabled ? a.localParticipant.setCameraEnabled(
          true,
          void 0,
          ((G3 = q3.camera) == null ? void 0 : G3.publishOptions) ?? {}
        ) : Promise.resolve(),
        (J3 = q3.screenShare) != null && J3.enabled ? a.localParticipant.setScreenShareEnabled(
          true,
          void 0,
          ((Se2 = q3.screenShare) == null ? void 0 : Se2.publishOptions) ?? {}
        ) : Promise.resolve()
      ]), await k2(N2), _2 && await B3.waitUntilConnected(N2), N2 == null || N2.removeEventListener("abort", S);
    },
    [a, F2, H3, k2, B3.waitUntilConnected]
  ), te3 = s.useCallback(async () => {
    await a.disconnect();
  }, [a]), X2 = s.useCallback(async () => {
    const L3 = await H3();
  ...
  return s.useEffect(
    ...
    () => ({
      ...T2,
      waitUntilConnected: k2,
      waitUntilDisconnected: F2,
      prepareConnection: X2,
      start: K3,
      end: te3
    }),
    [T2, k2, F2, X2, K3, te3]
...
function hr2(e3, n, t, r) {
  const o = s.useMemo(() => () => {
  }, []), i2 = s.useCallback(t ?? o, r ?? []), a = r ? i2 : t, c = s.useMemo(() => e3 ? "internal" in e3 ? e3.internal.emitter : e3 : null, [e3]);
  s.useEffect(() => {
    if (!(!c || !a))
      return c.on(n, a), () => {
        c.off(n, a);
...
var kn2 = ((e3) => (e3.MessageReceived = "messageReceived", e3))(kn2 || {});
function br2(e3) {
  const { room: n } = da(e3), t = s.useMemo(
    () => new ge2.EventEmitter(),
    []
  ), r = Ue2(e3), o = hn2({ room: n }), i2 = s.useMemo(() => ({ room: n }), [n]), a = rn2(i2), c = s.useMemo(() => o.map((d) => {
    var v, M2, w;
    switch (d.participantInfo.identity) {
      ...
      case ((M2 = r.internal.workerParticipant) == null ? void 0 : M2.identity):
        return {
      ...
      default:
        return {
          ...
          from: Array.from(n.remoteParticipants.values()).find(
            (A3) => A3.identity === d.participantInfo.identity
          )
        };
    }
    ...
    return u.sort((v, M2) => {
      const w = p.current.get(v.id), A3 = p.current.get(M2.id);
      return typeof w > "u" || typeof A3 > "u" ? 0 : w.getTime() - A3.getTime();
    });
...
// node_modules/@livekit/components-react/dist/components-B0PMXyIS.mjs
var e = __toESM(require_react(), 1);
var import_react2 = __toESM(require_react(), 1);
var ca2 = e.forwardRef(
  function(n, a) {
    const { buttonProps: c } = Nn2(n);
...
var sa2 = e.forwardRef(
  function(n, a) {
    const { mergedProps: c } = Zn2({ props: n });
    return e.createElement("button", { ref: a, ...c }, n.children);
  }
);
var ia2 = e.forwardRef(
  function(n, a) {
    const { buttonProps: c } = xn2(n);
    return e.createElement("button", { ref: a, ...c }, n.children);
  }
);
...
var ie3 = (t) => e.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...t }, e.createElement(
  "path",
  {
    fill: "currentcolor",
    fillRule: "evenodd",
...
var Re3 = (t) => e.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: 20, height: 16, fill: "none", ...t }, e.createElement(
  "path",
  {
    fill: "currentColor",
    fillRule: "evenodd",
...
var Tt = e.forwardRef(
  function({ trackRef: n, ...a }, c) {
    const r = Bn(), { mergedProps: s2, inFocus: o } = Un2({
      trackRef: n ?? r,
      props: a
    });
...
var fa2 = e.forwardRef(
  function({
    ...
    const f = Qo(), p = e.useRef("default"), E = e.useCallback(
      ...
      [f, d]
    ), { devices: h, activeDeviceId: m, setActiveMediaDevice: y, className: C } = Vn2({
      kind: n,
      room: f,
      track: l,
      requestPermissions: i2,
...
var ha = e.forwardRef(
  function({ label: n = "Allow Audio", ...a }, c) {
    const r = la(a.room), { mergedProps: s2 } = Kn({ room: r, props: a });
    return e.createElement("button", { ref: c, ...s2 }, n);
  }
);
var ga = e.forwardRef(
  function({ label: n, ...a }, c) {
    const r = ua(), { mergedProps: s2, canPlayAudio: o } = Kn({ room: r, props: a }), { mergedProps: l, canPlayVideo: i2 } = Yn({ room: r, props: s2 }), { style: d, ...u } = l;
...
function Me2(t, n) {
  switch (t) {
    ...
    case Track.Source.ScreenShare:
      return n ? e.createElement(xt2, null) : e.createElement(Re3, null);
    default:
      return;
  }
}
...
var va = e.forwardRef(function({ showIcon: n, ...a }, c) {
  const { buttonProps: r, enabled: s2 } = nr2(a), [o, l] = e.useState(false);
  return e.useEffect(() => {
    l(true);
  }, []), o && e.createElement("button", { ref: c, ...r }, (n ?? true) && Me2(a.source, s2), a.children);
});
var ye2 = e.forwardRef(function(n, a) {
  const { className: c, quality: r } = _n2(n), s2 = e.useMemo(() => ({ ...G2(n, { className: c }), "data-lk-quality": r }), [r, n, c]);
  return e.createElement("div", { ref: a, ...s2 }, n.children ?? At2(r));
});
var K2 = e.forwardRef(
  function({ participant: n, ...a }, c) {
    const r = ca(n), { className: s2, infoObserver: o } = e.useMemo(() => Fs(r), [r]), { identity: l, name: i2 } = O(o, {
      name: r.name,
      identity: r.identity,
      metadata: r.metadata
...
var be2 = e.forwardRef(
  function({ trackRef: n, show: a = "always", ...c }, r) {
    const { className: s2, isMuted: o } = tr2(n), l = a === "always" || a === "muted" && o || a === "unmuted" && !o, i2 = e.useMemo(
      () => G2(c, {
        className: s2
      }),
      [s2, c]
    );
    return l ? e.createElement("div", { ref: r, ...i2, "data-lk-muted": o }, c.children ?? Me2(n.source, !o)) : null;
  }
);
...
function Lt2() {
  ...
  function m(g, R, w) {
    var M2, P2, O3, L3, b, T2, F2 = 0, re2 = false, Z2 = false, D2 = true;
    if (typeof g != "function")
      throw new TypeError(t);
    R = N2(R) || 0, y(w) && (re2 = !!w.leading, Z2 = "maxWait" in w, O3 = Z2 ? p(N2(w.maxWait) || 0, R) : O3, D2 = "trailing" in w ? !!w.trailing : D2);
    function U2(k2) {
      var x2 = M2, H3 = P2;
    ...
    function Pe3(k2) {
      ...
      return Z2 ? E(se2, O3 - H3) : se2;
    }
    function ce2(k2) {
      var x2 = k2 - T2, H3 = k2 - F2;
      return T2 === void 0 || x2 >= R || x2 < 0 || Z2 && H3 >= O3;
    }
    function W3() {
      var k2 = h();
      if (ce2(k2))
        return le2(k2);
      b = setTimeout(W3, Pe3(k2));
    }
    function le2(k2) {
      return b = void 0, D2 && M2 ? U2(k2) : (M2 = P2 = void 0, L3);
    }
    function Te() {
    ...
    return G3.cancel = Te, G3.flush = Ae3, G3;
  }
  function y(g) {
    var R = typeof g;
...
var Bt2 = e.forwardRef(
  function({
    ...
    const u = Ht2({ root: d.current }), [v] = Zt3(u, 3e3);
    e.useEffect(() => {
...
var Ot2 = e.forwardRef(
  function({
    ...
    var p, E;
    const l = sa(n), { elementProps: i2 } = zn2({
      htmlProps: s2,
      disableSpeakingIndicator: r,
      onParticipantClick: c,
      trackRef: l
    }), d = ar2(l.participant), u = Ko(), v = (p = pa()) == null ? void 0 : p.autoSubscription, f = e.useCallback(
      (h) => {
    ...
    ), e.createElement(K2, null)) : e.createElement(e.Fragment, null, e.createElement(Re3, { style: { marginRight: "0.25rem" } }), e.createElement(K2, null, "'s screen"))), e.createElement(ye2, { className: "lk-participant-metadata-item" }))), e.createElement(Tt, { trackRef: l }))));
  }
);
function Ea(t) {
...
function Wt3({
  ...
  }, [r]), e.createElement("div", { className: "lk-pagination-control", "data-lk-user-interaction": s2 }, e.createElement("button", { className: "lk-button", onClick: a }, e.createElement(ie3, null)), e.createElement("span", { className: "lk-pagination-count" }, `${c} of ${t}`), e.createElement("button", { className: "lk-button", onClick: n }, e.createElement(ie3, null)));
}
var qt2 = e.forwardRef(
...
function wa({ tracks: t, ...n }) {
  const a = e.createRef(), c = e.useMemo(
    ...
    [n]
  ), { layout: r } = Hn2(a, t.length), s2 = jn2(r.maxTiles, t);
  return Xn2(a, {
    onLeftSwipe: s2.nextPage,
    onRightSwipe: s2.prevPage
  }), e.createElement("div", { ref: a, "data-lk-pagination": s2.totalPageCount > 1, ...c }, e.createElement(Ce2, { tracks: s2.tracks }, n.children), t.length > r.maxTiles && e.createElement(e.Fragment, null, e.createElement(
    qt2,
    {
...
function ka({ tracks: t, orientation: n, ...a }) {
  const c = e.useRef(null), [r, s2] = e.useState(0), { width: o, height: l } = Jt2(c), i2 = n || (l >= o ? "vertical" : "horizontal"), d = i2 === "vertical" ? Math.max(o * Ut2, $t3) : Math.max(l * Ie2, Dt2), u = rs(), v = Math.max(i2 === "vertical" ? (l - u) / d : (o - u) / d, me2);
  let f = Math.round(v);
  ...
  }, [f, i2]), e.createElement("aside", { key: i2, className: "lk-carousel", ref: c, ...a }, e.createElement(Ce2, { tracks: p }, a.children));
}
function Ra({
  value: t,
  onPinChange: n,
...
var Ma = e.forwardRef(
  function({ trackRef: n, ...a }, c) {
    const u = sa(n), v = cr2(u, { bands: 7, loPass: 300 });
...
var Ca = e.forwardRef(
  function({
    ...
    const l = sa(r), { elementProps: i2 } = zn2({
      trackRef: l,
      htmlProps: s2,
      disableSpeakingIndicator: a,
      onParticipantClick: c
    });
    return e.createElement("div", { ref: o, style: { position: "relative", minHeight: "160px" }, ...i2 }, e.createElement(jn.Provider, { value: l }, n ?? e.createElement(e.Fragment, null, B(l) && e.createElement(ne3, { trackRef: l }), e.createElement(Kt3, { barCount: 7, options: { minHeight: 8 } }), e.createElement("div", { className: "lk-participant-metadata" }, e.createElement("div", { className: "lk-participant-metadata-item" }, e.createElement(be2, { trackRef: l }), e.createElement(K2, null)), e.createElement(ye2, { className: "lk-participant-metadata-item" })))));
  }
);
function Ia(t) {
  const [n, a] = e.useState(void 0), c = re(t.room);
  return e.useEffect(() => {
    switch (c) {
      case ConnectionState.Reconnecting:
        a(
          e.createElement(e.Fragment, null, e.createElement(oe3, { className: "lk-spinner" }), " Reconnecting")
        );
        break;
      case ConnectionState.Connecting:
        a(
          e.createElement(e.Fragment, null, e.createElement(oe3, { className: "lk-spinner" }), " Connecting")
        );
        break;
      case ConnectionState.Disconnected:
...
function ee({
  ...
  const g = e2.useRef(null), m = e2.useRef(null), l = e2.useMemo(() => ({ messageDecoder: d, messageEncoder: u, channelTopic: n }), [d, u, n]), { chatMessages: c, send: I3, isSending: t } = rn2(l), h = Ko(), i2 = e2.useRef(0);
  async function v(s2) {
...
function et2(r, d, u) {
  const [n, S] = e2.useState(null), [g, m] = e2.useState(false), l = qn({ kind: u }), [c, I3] = e2.useState(
    void 0
...
function tt2({
  ...
  const {
    ...
    preventSave: !I3,
    preventLoad: !I3
  }), [a, w] = e2.useState(i2), [b, A3] = e2.useState(a.audioEnabled), [y, L3] = e2.useState(a.videoEnabled), [T2, $2] = e2.useState(a.audioDeviceId), [p, M2] = e2.useState(a.videoDeviceId), [V2, ae] = e2.useState(a.username);
  e2.useEffect(() => {
    s2(b);
  }, [b, s2]), e2.useEffect(() => {
    o(y);
  ...
  const D2 = Ke2(
    ...
    () => D2 == null ? void 0 : D2.filter((C) => C.kind === Track.Kind.Video)[0],
    [D2]
  ), ne4 = e2.useMemo(() => {
    if (P2) {
    ...
    () => D2 == null ? void 0 : D2.filter((C) => C.kind === Track.Kind.Audio)[0],
    [D2]
  );
  e2.useEffect(() => (U2.current && P2 && (P2.unmute(), P2.attach(U2.current)), () => {
    P2 == null || P2.detach();
  }), [P2]);
  const [ce2, se2] = e2.useState(), _2 = e2.useCallback(
...
function te2({
  ...
  const I3 = Dn2(`(max-width: ${g ? 1e3 : 760}px)`) ? "minimal" : "verbose";
  r ?? (r = I3);
  const t = { leave: true, ...d }, h = Bn2();
  if (!h)
  ...
  } = or2({ preventSave: !u }), L3 = e2.useCallback(
    (p, M2) => M2 ? w(p) : null,
    [w]
  ), T2 = e2.useCallback(
    (p, M2) => M2 ? b(p) : null,
...
function at2({
  ...
  }, t = ra(), h = c.filter(B).filter((o) => o.publication.source === Track.Source.ScreenShare), i2 = (s2 = Gn(t)) == null ? void 0 : s2[0], v = c.filter((o) => !ts(o, i2));
  return e2.useEffect(() => {
    var o, E, a, w, b, A3;
    ...
    e2.createElement("div", { className: "lk-video-conference-inner" }, i2 ? e2.createElement("div", { className: "lk-focus-layout-wrapper" }, e2.createElement(Ea, null, e2.createElement(ka, { tracks: v }, e2.createElement(Ot2, null)), i2 && e2.createElement(pa2, { trackRef: i2 }))) : e2.createElement("div", { className: "lk-grid-layout-wrapper" }, e2.createElement(wa, { tracks: c }, e2.createElement(Ot2, null))), e2.createElement(te2, { controls: { chat: true, settings: !!n } })),
    e2.createElement(
      ee,
      {
...
function nt2({ ...r }) {
  const [d, u] = e2.useState({
    showChat: false,
    unreadMessages: 0
  }), n = rr2([Track.Source.Microphone]);
  return j2(), e2.createElement(Ra, { onWidgetChange: u }, e2.createElement("div", { className: "lk-audio-conference", ...r }, e2.createElement("div", { className: "lk-audio-conference-stage" }, e2.createElement(Ce2, { tracks: n }, e2.createElement(Ca, null))), e2.createElement(
    te2,
    {
...
function ct2({
  ...
  const S = { leave: true, microphone: true, ...r }, g = Bn2(), { microphoneTrack: m, localParticipant: l } = xe2(), c = e2.useMemo(() => ({
    participant: l,
    source: Track.Source.Microphone,
    publication: m
  }), [l, m]);
  g ? S.microphone ?? (S.microphone = g.canPublish) : S.microphone = false;
  const I3 = G2({ className: "lk-agent-control-bar" }, n), { saveAudioInputEnabled: t, saveAudioInputDeviceId: h } = or2({
    preventSave: !d
  }), i2 = e2.useCallback(
    (v, s2) => {
      s2 && t(v);
...
export {
  ...
  O2 as MediaDeviceMenu,
  fa2 as MediaDeviceSelect,
  kn2 as MessagesEvent,
  ...
  us as setLogLevel,
  Ue2 as useAgent,
  In2 as useAudioPlayback,
  ur2 as useAudioWaveform,
  rn2 as useChat,
  Zn2 as useChatToggle,
  Nn2 as useClearPinButton,
  _n2 as useConnectionQualityIndicator,
  re as useConnectionState,
  ra as useCreateLayoutContext,
  Fn2 as useDataChannel,
  xn2 as useDisconnectButton,
  ...
  Un2 as useFocusToggle,
  Hn2 as useGridLayout,
  ar2 as useIsEncrypted,
  Ee2 as useIsMuted,
  fr2 as useIsRecording,
  Qt2 as useIsSpeaking,
  ta as useLayoutContext,
  $ as useLiveKitRoom,
  xe2 as useLocalParticipant,
  Bn2 as useLocalParticipantPermissions,
  ...
  Vn2 as useMediaDeviceSelect,
  qn as useMediaDevices,
  cr2 as useMultibandTrackVolume,
  jn2 as usePagination,
  dr2 as useParticipantAttribute,
  mn2 as useParticipantAttributes,
  aa as useParticipantContext,
  Yt2 as useParticipantInfo,
  Wn2 as useParticipantPermissions,
  zn2 as useParticipantTile,
  ie2 as useParticipantTracks,
  Xt2 as useParticipants,
  or2 as usePersistentUserChoices,
  Gn as usePinnedTracks,
  et2 as usePreviewDevice,
  Ke2 as usePreviewTracks,
  Jn2 as useRemoteParticipant,
  ve2 as useRemoteParticipants,
  ua as useRoomContext,
  $n2 as useRoomInfo,
  mr2 as useSequentialRoomConnectDisconnect,
  pr2 as useSession,
  fa as useSessionContext,
  br2 as useSessionMessages,
  Qn as useSortedParticipants,
  Zt2 as useSpeakingParticipants,
  Kn as useStartAudio,
  Yn as useStartVideo,
  Xn2 as useSwipe,
  pn2 as useTextStream,
  er2 as useToken,
  sr2 as useTrackByName,
  tr2 as useTrackMutedIndicator,
  oa as useTrackRefContext,
  nr2 as useTrackToggle,
  fn2 as useTrackTranscription,
  ir2 as useTrackVolume,
  rr2 as useTracks,
  hn2 as useTranscriptions,
  Kt2 as useVisualStableUpdate,
  lr2 as useVoiceAssistant
};
