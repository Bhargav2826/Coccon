  ...
  helmet: {
    ...
    contentSecurityPolicy: {
      directives: {
        ...
        connectSrc: ["'self'", "http://localhost:*", "ws://localhost:*", "http://127.0.0.1:*", "ws://127.0.0.1:*", "*.livekit.cloud", "*.deepgram.com", "blob:", "data:"],
        fontSrc: ["'self'", "https:", "data:", "https://fonts.gstatic.com"],
        objectSrc: ["'none'"],
        mediaSrc: ["'self'", "https:", "data:", "blob:", "https://*.livekit.cloud"],
